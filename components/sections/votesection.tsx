        ...
        <section className="py-10 bg-primary">
            ...
            {loading ? (
                ...
                <div className="mt-12 max-w-2xl mx-auto">
                    <div className="bg-primary rounded-3xl p-4 md:p-12 text-center">
                        <div className="mb-6">
                        ...
                        <div className="flex gap-4 justify-center">
                            <Link 
                                href="/projects" 
                                className="inline-block bg-secondary text-dark font-semibold px-4 py-3 rounded-2xl hover:scale-105 transition-transform"
                            >
                                Browse Projects
                            </Link>
                            <Link 
                                href="/votes" 
                                className="inline-block bg-white text-dark font-semibold px-4 py-3 rounded-2xl border border-dark hover:bg-gray-50 transition-colors"
                            >
                                Past Votes
                            </Link>
                        </div>
