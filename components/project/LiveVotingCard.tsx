  ...
  return (
    <div className="bg-white border-1 border-dark rounded-2xl p-6">
      ...
      <div className="space-y-3 mb-6">
        <button
          onClick={() => onVote?.('no')}
          className="w-full py-4 rounded-xl font-semibold transition-all border bg-[#FEE4E2] border-[#F04438] text-red-600 hover:bg-[#FEE4E2]/10"
        >
          No
        </button>
        <button
          onClick={() => onVote?.('yes')}
          className="w-full py-4 rounded-xl font-semibold transition-all border bg-[#E5FBDD] border-[#3A9E1B] text-green-600 hover:bg-[#E5FBDD]/10"
        >
          Yes
        </button>
      </div>
